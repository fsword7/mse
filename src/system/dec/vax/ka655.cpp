...
//COMPUTER(mv3800,  nullptr, vax, KA655, ka655_device, mv3800,  mv3800_init,  "DEC", "MicroVAX 3800", SYSTEM_NOT_WORKING)
//COMPUTER(mv3800x, nullptr, vax, KA655, ka655_device, mv3800x, mv3800x_init, "DEC", "MicroVAX 3800x", SYSTEM_NOT_WORKING)
COMPUTER(mv3900,  nullptr, vax, KA655, ka655_sysDevice, mv3900,  mv3900_init,  "DEC", "MicroVAX 3900", SYSTEM_NOT_WORKING)
COMPUTER(mv3900x, nullptr, vax, KA655, ka655_sysDevice, mv3900x, mv3900x_init, "DEC", "MicroVAX 3900x", SYSTEM_NOT_WORKING)

// VAXserver 3x00 series
//COMPUTER(vs3500,  nullptr, vax, KA650, ka650_device, mv3500,  mv3500_init,  "DEC", "VAXserver 3500", SYSTEM_NOT_WORKING)
//COMPUTER(vs3600,  nullptr, vax, KA650, ka650_device, mv3600,  mv3600_init,  "DEC", "VAXserver 3600", SYSTEM_NOT_WORKING)
//COMPUTER(vs3800,  nullptr, vax, KA655, ka655_device, mv3800,  mv3800_init,  "DEC", "VAXserver 3800", SYSTEM_NOT_WORKING)
//COMPUTER(vs3800x, nullptr, vax, KA655, ka655_device, mv3800x, mv3800x_init, "DEC", "VAXserver 3800x", SYSTEM_NOT_WORKING)
COMPUTER(vs3900,  nullptr, vax, KA655, ka655_sysDevice, mv3900,  mv3900_init,  "DEC", "VAXserver 3900", SYSTEM_NOT_WORKING)
COMPUTER(vs3900x, nullptr, vax, KA655, ka655_sysDevice, mv3900x, mv3900x_init, "DEC", "VAXserver 3900x", SYSTEM_NOT_WORKING)
