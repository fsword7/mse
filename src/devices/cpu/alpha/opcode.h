...
enum opCodes {
	OPC_PAL = 0, OPC_01,	  OPC_02,		OPC_03,
	OPC_04,		 OPC_05,	  OPC_06,		OPC_07,
	OPC_LDA,	 OPC_LDAH,	  OPC_LDBU,		OPC_LDQ_U,
	OPC_LDWU,	 OPC_STW,	  OPC_STB,		OPC_STQ_U,
	OPC_INTA,	 OPC_INTL,	  OPC_INTS,		OPC_INTM,
	OPC_ITFP,	 OPC_FLTV,	  OPC_FLTI,		OPC_FLTL,
	OPC_MISC,	 OPC_HW_MFPR, OPC_JSR,		OPC_HW_LD,
	OPC_FPTI,	 OPC_HW_MTPR, OPC_RET,		OPC_HW_ST,
	OPC_LDF,	 OPC_LDG,	  OPC_LDS,		OPC_LDT,
