/*
 * ev4_pal.cpp - 21064 series - EV4 PAL hardware instructions
 *
...
void dec21064_cpuDevice::call_pal(uint32_t opWord)
{
...
// HW_REI instruction
void dec21064_cpuDevice::hw_ret(uint32_t opWord)
{
//	setPC(state.excAddr);
}

// HW_LD Instruction
void dec21064_cpuDevice::hw_ld(uint32_t opWord)
{
...
// HW_ST instruction
void dec21064_cpuDevice::hw_st(uint32_t opWord)
{
...
// HW_MTPR instruction
void dec21064_cpuDevice::hw_mfpr(uint32_t opWord)
{
...
// HW_MFPR instruction
void dec21064_cpuDevice::hw_mtpr(uint32_t opWord)
{
	int fnc = opWord & 0xFFFF;
	uint64_t rbv;
//
